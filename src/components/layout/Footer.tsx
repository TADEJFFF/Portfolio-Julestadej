  ...
  return (
    <footer className="border-t border-[#d0d0d0] bg-[#f9f9f9]">
      <div className="max-w-7xl mx-auto px-6 py-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div>
              ...
              <div className="font-display text-xs text-[#9A7200] mt-0.5">BUT GEA GEMA · Parcours GEMA</div>
            </div>
        ...
        {/* ── Bas de footer ── */}
        <div className="mt-6 pt-4 border-t border-[#e0e0e0] flex flex-col md:flex-row items-center justify-between gap-2">
