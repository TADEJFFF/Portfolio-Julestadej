      ...
      <div className="max-w-3xl mx-auto px-6 text-center">
        ...
        <AnimatedSection delay={0.1} className="mb-8">
          ...
          >
            ...
            <div className="text-left">
              <div className="font-display text-xs text-[#444444] uppercase tracking-widest mb-0.5">
                Email
              </div>
        ...
        <AnimatedSection delay={0.2} className="mb-12">
          <div className="flex flex-wrap justify-center gap-4">
            ...
            <a
              ...
              className="flex items-center gap-3 px-5 py-3 rounded-xl border border-[#b8b8b8] bg-white hover:border-[#0A66C2]/60 hover:bg-[#0A66C2]/5 transition-all duration-200"
            >
              ...
              <div className="text-left">
                <div className="font-display text-[10px] text-[#444444] uppercase tracking-widest">LinkedIn</div>
                <div className="font-display text-sm text-[#111111] font-medium">Jules TADEJ</div>
              </div>
            </a>

            {/* Localisation */}
            <div className="flex items-center gap-3 px-5 py-3 rounded-xl border border-[#b8b8b8] bg-white">
              <MapPin size={16} className="text-[#444444]" />
              <div className="text-left">
                <div className="font-display text-[10px] text-[#444444] uppercase tracking-widest">Localisation</div>
        ...
        <AnimatedSection delay={0.3}>
          <div className="flex items-center gap-4 mb-8">
            ...
            <span className="font-display text-xs text-[#444444]">Jules TADEJ · 2026</span>
            <div className="flex-1 h-px bg-[#1e1e1e]" />
          </div>
          <p className="font-display text-xs text-[#444444] leading-relaxed">
