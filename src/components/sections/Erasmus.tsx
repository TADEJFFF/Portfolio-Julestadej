...
const gradeColor = (grade: string) => {
  ...
  return "text-[#b0b0b0] bg-[#1a1a1a] border-[#272727]";
};
      ...
      <div className="max-w-5xl mx-auto px-6">
            ...
            <div className="h-full rounded-2xl border border-[#FFD300]/20 bg-[#141414] p-6 flex flex-col gap-6">
              ...
              <div>
                ...
                <div className="flex flex-col gap-2">
                  {[
                    ...
                    <div key={label} className="flex items-center gap-2 text-sm text-[#b0b0b0] font-display">
              ...
              <div className="mt-auto grid grid-cols-2 gap-3">
                <div className="rounded-xl border border-[#272727] bg-[#0c0c0c] p-4 text-center">
                  ...
                  <div className="font-display text-[10px] text-[#888888] uppercase tracking-wider mt-1">
                    Crédits ECTS
                  </div>
                </div>
                <div className="rounded-xl border border-[#272727] bg-[#0c0c0c] p-4 text-center">
              ...
              <div className="rounded-xl border border-[#272727] bg-[#0c0c0c] px-4 py-3">
                <div className="font-display text-xs text-[#888888] uppercase tracking-wide mb-1">
          ...
          <AnimatedSection direction="right" className="lg:col-span-3" delay={0.1}>
            <div className="rounded-2xl border border-[#272727] bg-[#141414] overflow-hidden">
              <div className="px-6 py-4 border-b border-[#272727] flex items-center justify-between">
                ...
                <span className="font-display text-xs text-[#888888]">
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-[#1e1e1e]">
                    <th className="text-left px-6 py-3 font-display text-[10px] uppercase tracking-widest text-[#888888]">
                      Matière
                    </th>
                    <th className="text-center px-4 py-3 font-display text-[10px] uppercase tracking-widest text-[#888888]">
                      ECTS
                    </th>
                    <th className="text-center px-4 py-3 font-display text-[10px] uppercase tracking-widest text-[#888888]">
                      Note
              ...
              <div className="px-6 py-4 border-t border-[#272727] bg-[#0c0c0c]/50 flex items-center justify-between">
                <span className="font-display text-sm text-[#b0b0b0]">Total validé</span>
        ...
        <AnimatedSection delay={0.2} className="mt-6">
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-lg border border-[#272727] bg-[#141414]">
            <span className="font-display text-xs text-[#888888]">Student ID UNWE Sofia :</span>
