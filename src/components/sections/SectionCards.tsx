...
const cards = [
  {
    ...
    Icon: Route,
    label: "Parcours",
    titre: "Trois ans pour construire une posture professionnelle",
  ...
  },
  {
    ...
    Icon: Plane,
    label: "Erasmus+ · Sofia",
    titre: "Un semestre en anglais, seul à 1 500 km",
  ...
  },
  {
    ...
    label: "Stage FFF",
    titre: "Après les médias et le retail, l'agroalimentaire",
  ...
  },
  {
    ...
    Icon: FolderOpen,
    label: "Projets",
    titre: "Ce qu'on m'a confié, et ce que j'en ai fait",
  ...
  },
  {
    ...
    Icon: BarChart2,
    label: "Compétences",
    titre: "5 compétences, 3 ans pour les acquérir",
